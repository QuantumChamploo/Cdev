...
# 708 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 1166 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 1186 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 1214 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 207 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/i386/_mcontext.h" 3 4
...
# 70 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/string.h" 3 4
...
# 155 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/string.h" 3 4
...
# 70 "/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/strings.h" 3 4
...
char * read_cipher_file() {
    ...
    if (fp == ((void *)0)) {
        fprintf(__stderrp, "Cannot open file for reading.\n");
        exit(1);
    }
    ...
    if (fgets(str, 1000, fp) == ((void *)0)) {
        fprintf(__stderrp, "Error reading ciphertext file.\n");
        exit(1);
    }
...
char * get_login_key() {
    ...
    if (fgets (str, 50, __stdinp) == ((void *)0)) {
        fprintf(__stderrp, "Error reading user input.\n");
        exit(1);
    }
    int len = strlen(str);
